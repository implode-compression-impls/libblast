...
* implemented hardening with [Hardening.cmake](https://github.com/KOLANICH-libs/Hardening.cmake)


Bindings
--------
* https://github.com/implode-compression-impls/pkblast.py - Python bindings of this lib
...
* https://github.com/implode-compression-impls/pklib - an impl extracted from [Ladislav Zezula](https://github.com/ladislav-zezula)'s [StormLib](https://github.com/ladislav-zezula/StormLib). Contains a compressor, [`libimplode](https://github.com/implode-compression-impls/pklib/tree/master/src/implode)
